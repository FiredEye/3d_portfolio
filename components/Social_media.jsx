...
Command: npx gltfjsx@6.1.4 social_media.gltf --transform
...
export default function Model(props) {
  const { nodes, materials } = useGLTF("/social_media-transformed.glb");
  return (
...
useGLTF.preload("/social_media-transformed.glb");
